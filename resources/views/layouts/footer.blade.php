...
<footer class="bg-dark text-center text-white">
    ...
    <section class="">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a href="/connection" class="text-white">Connection</a>
            </li>
            <li>
              <a href="/matches" class="text-white">Matches</a>
            </li>
            <li>
              <a href="/subscription" class="text-white">Subscription</a>
            </li>
            <li>
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2020 Copyright:
    <a class="text-white">Sonarsaptapadi.com</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->